...
//				System.out.println("edgeID-> " + edgeID);
				...
				if ( dumpRoadEndLocation == true ) {
					...
					//************************************* auto add-road function ¡õ¡õ¡õ¡õ¡õ¡õ¡õ¡õ  ***********************
...
//						System.out.println("ADD!   " + edgeID + "   " + roadIndex + " " + endPosition_X + " " + endPosition_Y + " " + RoadMaxSpeed);
					...
					//************************************* auto add-road function ¡ô¡ô¡ô¡ô¡ô¡ô¡ô¡ô¡ô¡ô¡ô¡ô *************************						
				}				
...
//							System.out.println(timeID + " " + vehID + " " + a + " " + b );
						...
						if (dumpTrace == true ) {
							String tempStr = "";							
							if ( dumpRoadEndLocation == true ) {
								//************************************* auto add-node function ¡õ¡õ¡õ¡õ¡õ¡õ¡õ¡õ  ***********************
								...
								//************************************* auto add-node function ¡ô¡ô¡ô¡ô¡ô¡ô¡ô¡ô¡ô¡ô¡ô¡ô *************************
...
//								tempStr = String.valueOf(intTimeVal) + " " + nodeIndex + " " + vehID + " " + a + " " + b + " " + speed + " " + numDirection + " " + roadIndex + " " + edgeID;
								tempStr = String.valueOf(intTimeVal) + " " + nodeIndex + " " + a + " " + b + " " + speed + " " + numDirection + " " + roadIndex;
								
							} else {
								tempStr = String.valueOf(intTimeVal) + " " + vehID + " " + a + " " + b + " " + speed + " " + direction + " " + edgeID;
							}
...
//		}
	...
	public void write(String tclFile, String traceFile) {
		...
		if (traCImode == true) {
			...
			for (int index = 0; index < listLength; index++) {
				NSNode temNode = (NSNode) initialNode.get(index);
				printer.println("  $ns_ at $i \"$mobilityInterfaceClient command-enablePositionUpdate " + index + " " + temNode.getID() + "\"");							
			}
			printer.println("}\n");
