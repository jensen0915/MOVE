...
public class DynamicMobilityTCLEditor extends JFrame {
	...
	public DynamicMobilityTCLEditor() {
		setSize(1000, 800);
...
//		getContentPane().setBackground(Color.WHITE);
		...
		jLabel1.setText("Dynamic Traffic Model Generator for NS-2");
...
//		setBounds(0, 0, 1000, 750);		
	...
	class NodesDynamicTableModel extends AbstractTableModel {
		...
		private void importSUMOMenuActionPerformed(ActionEvent evt) throws Exception{
			...
			ns = new buildNS(sumoFile, netFile, true);
