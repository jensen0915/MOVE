...
public class frontEnd extends JFrame {
	...
	private void initComponents() {
		...
		tigerButton.setText("Convert TIGER");
		...
		jLabel7.setText("Generate map from TIGER");
		gridBagConstraints = new GridBagConstraints();
		gridBagConstraints.gridx = 12;
		gridBagConstraints.gridy = 17;
		...
		jLabel25.setText("Import  Map Database");
		gridBagConstraints = new GridBagConstraints();
		gridBagConstraints.gridx = 0;
...
//        getContentPane().add(scrollPane, gridBagConstraints);
	...
	private void tigerButtonActionPerformed(ActionEvent evt) {
		...
		if ( sumoBinariesFlag == 0 && osenv == 0){
			...
			tigerConvert importTiger = new tigerConvert(sumoPath,osenv);
		}		
	}
